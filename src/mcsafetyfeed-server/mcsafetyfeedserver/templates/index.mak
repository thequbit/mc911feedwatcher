...
<%inherit file="base.mak"/>
    ...
    <div class="row" id="top-orbit">
        ...
        "RochesterCollage4" by EastOfWest - Own work. Licensed under Creative Commons Attribution-Share Alike 3.0 via Wikimedia Commons - http://commons.wikimedia.org/wiki/File:RochesterCollage4.jpg#mediaviewer/File:RochesterCollage4.jpg
        </center>
    </div>
    <hr/>
    ...
    <div class="row">
        <div class="large-4 columns">
            <center><a class="button" id="button-live-911-feed" href="/feed">Live 911 Feed</a></center>
        </div>
        <div class="large-4 columns">
            <center><a class="button" id="button-view-accidents" href="/accidents">View Accidents</a></center>
        </div>
        <div class="large-4 columns">
            <center><a class="button" id="search-incidents" href="/search">Search Incidents</a></center>
        </div>
    </div>
